...
import { FuelDashboardHeadCells } from './GroundHandlingData';
    ...
    <Grid container direction='column' spacing={3}>
      ...
      <Grid item md={12} xs={12} align='right'>
        <Button
          ...
          variant='contained'
          type='submit'
          onClick={() => dispatch(openModal(true, 'GroundHandlingQuote', 'md'))}
        >
          <div
            style={{
              display: 'flex',
        ...
        <Button
          ...
          variant='contained'
          type='submit'
          onClick={() => dispatch(openModal(true, 'GroundHandlingQuery', 'md'))}
        >
          <div
            style={{
              display: 'flex',
        ...
        <Button
          ...
          variant='contained'
          type='submit'
          onClick={() => dispatch(openModal(true, 'GroundHandlingPreference', 'sm'))}
        >
          <div
            style={{
              display: 'flex',
