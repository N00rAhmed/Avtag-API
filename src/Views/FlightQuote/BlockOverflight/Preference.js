      ...
      <div className={classes.content}>
        ...
        >
          <Grid container direction='column'>
            ...
            >
                Monthly Block Permit Charges
            </Typography>
            <Grid item container direction='row' spacing={!matchesSM && 3}>
              <Grid item md={8} xs={12} className={classes.space}>
                <Controller
                  name='fuelProvider'
                  rules={{
                  ...
                  render={({ onChange, onBlur, value, name }) => (
                    <RHFInput
                      helperText='Civil Aviation / Local Agent'
            ...
            <Grid item container direction='row' spacing={!matchesSM && 3}>
              <Grid item md={8} xs={12} className={classes.space}>
                <Controller
                  ...
                  render={({ onChange, onBlur, value, name }) => (
                    <RHFInput
                      helperText='CAA Processing Fees'
                      rootHelperTextStyle={classes.input}
                      name={name}
                      value={value}
                      onBlur={onBlur}
