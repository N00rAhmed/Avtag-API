...
import { FuelDashboardHeadCells } from '../FuelData';
    ...
    <Grid container direction='column' spacing={3}>
      ...
      <Grid item md={12} xs={12} align='right'>
        <Button
          ...
          variant='contained'
          type='submit'
          onClick={() => dispatch(openModal(true, 'CreateFuelQuotation', 'md'))}
        >
          <div
            style={{
              display: 'flex',
        ...
        <Button
          ...
          variant='contained'
          type='submit'
          onClick={() => dispatch(openModal(true, 'CreateFuelQuery', 'md'))}
        >
          <div
            style={{
              display: 'flex',
        ...
        <Button
          ...
          variant='contained'
          type='submit'
          onClick={() => dispatch(openModal(true, 'CreateFuelSupplier', 'sm'))}
        >
          <div
            style={{
              display: 'flex',
